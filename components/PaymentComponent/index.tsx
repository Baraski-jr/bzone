  ...
  return (
    <div className="py-3 space-y-3">
      ...
      <p className="text-slate-500 text-sm">
        All transctions are secure and encrypted.
      </p>
      <form className="space-y-5">
          ...
          <div className="bg-slate-200 bg-opacity-50 w-full space-y-5 p-5">
            <div className="">
              ...
              <input
                ...
                className="text-sm border-b-2 border-slate-300 py-3 px-3 text-slate-700 w-full rounded-sm focus:outline-none focus:border-blue-500 hover:border-blue-200"
              />
            </div>
        ...
        <button
          type="button"
          onClick={() => sumbit()}
          className="block w-full py-3 bg-[#105889] text-white text-center rounded-sm hover:bg-[#2c71a1] transition-all duration-200"
        >
          Pay now
        </button>
      </form>
