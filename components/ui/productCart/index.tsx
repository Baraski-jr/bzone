        ...
        <div className="flex items-center justify-between gap-2">
          <h3 className="text-sm md:text-base font-semibold text-slate-900">
            ...
            <button
              ...
              className="py-1 px-3 rounded-full bg-opacity-0 hover:bg-opacity-95 bg-primary border-[1px] border-primary text-slate-950 hover:text-white transition-all duration-300 disabled:bg-opacity-60 disabled:text-white disabled:cursor-not-allowed"
            >
