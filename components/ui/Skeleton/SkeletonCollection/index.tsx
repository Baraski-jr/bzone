    ...
    return ( 
        ...
        <div className="w-[95%] mx-auto">
          <header className="space-y-2 py-5 px-2">
            <div className="mx-auto w-1/12 h-4 rounded-full skeleton"></div>
            <div className="mx-auto w-1/3 h-4 rounded-full skeleton"></div>
          </header>
          <div className="sm:flex lg:gap-4 gap-2 gap-y-3 sm:space-x-5 space-y-5 sm:space-y-0">
            {/* Banner Image */}
            <div className="block w-full h-96 sm:h-[370px] sm:w-1/2 lg:w-1/3 xl:w-1/4 skeleton"></div>
