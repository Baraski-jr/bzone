    ...
    <section className="pb-10">
      ...
      <div className="max-w-[300rem] w-[90%] mx-auto">
        <section className="py-7 space-y-3">
          <div className="md:hidden h-2 w-10/12 rounded-full pb-3 pl-3 skeleton animate-pulse"></div>
        ...
        <div className="space-y-5 py-3">
          <div className="mx-auto h-2 w-1/4 rounded-full skeleton animate-pulse"></div>
