                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:justify-items-end py-14 space-y-8 md:space-y-0 border-b-2 border-gray-500">
                    ...
                    <div className="flex w-full justify-between">
                        <div className="">
                            ...
                            <div className=""> 
                               <Link className='block hover:text-[#84BA86] active:underline transition-colors duration-200' href="/" >Home</Link>
                               <Link className='block hover:text-[#84BA86] active:underline transition-colors duration-200' href="/products/all" >Products</Link>
                               <Link className='block hover:text-[#84BA86] active:underline transition-colors duration-200' href="/cart" >Carts</Link>
                            </div>
                        </div>
                        {/* Third */}
                        <div className="">
                            ...
                            <div className=""> 
                               <h2>Busumbala</h2>
                               <a className='block hover:text-[#84BA86] active:underline transition-colors duration-200' href="mailto:bzone@gmail.com">bzone@gmail.com</a>
                               <a className='block hover:text-[#84BA86] active:underline transition-colors duration-200' href="tel:+220 000 0000">+200 000 0000</a> 
                            </div>
                        </div>
                    </div> 
                </div>
