...
const SubHero = ({title, links}: SubHeroPropType) => {
  return (
      <>
      <Gutter />
      <section className='bg-subHero-bg bg-cover bg-center h-[10dvh] md:h-40 w-full grid place-content-center'> 
        <h1 className="text-center text-base text-slate-300 md:font-semibold pb-2">{title}</h1>
