    ...
    <div className="w-full flex md:items-center gap-7">
      ...
      <div className="flex-1 flex items-center gap-x-5 w-full">
        <button
          ...
          className="flex-1 bg-opacity-0 hover:bg-opacity-95 rounded-md bg-primary border-2 border-primary text-slate-950 hover:text-white text-base h-12 transition-all duration-300 disabled:bg-opacity-80 disabled:text-white disabled:cursor-not-allowed"
        >
          {name}
        </button>
      </div>
