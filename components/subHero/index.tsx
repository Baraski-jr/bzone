...
const SubHero = () => {
  return (
    <section className="py-5 md:mt-10 w-full">
      <div className="h-full py-5 bg-subHero-bg bg-cover bg-no-repeat bg-center md:py-20 px-5 w-full mx-auto flex items-center md:min-h-[50vh]">
