...
export default function FreeReview() {
  return (
    <div className="bg-[#141414] ">
      <div className=" max-w-[100rem] w-[95%] mx-auto border-b-[.4px] border-slate-300 grid grid-cols-2 gap-8 md:flex flex-wrap justify-evenly items-center py-16 mt-11">
