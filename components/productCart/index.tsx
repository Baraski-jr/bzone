  ...
  return (
    <Link href={`/Products/${id}`} className='relative grid place-content py-5 mb-1 md:py-0 h-full md:h-80 rounded-md hover:bg-slate-50 transition-all duration-200'>
      <div className="overflow-hidden bg-[#F5F5F5]">
        <Image width={580} height={200} src={imageUrl} alt={name} className='w-full scale-150 object-cover translate-y-3 hover:translate-y-0 transition-all duration-700 ' />
      </div>
      <div className='flex flex-col justify-center  space-y-1 px-2 pb-2 mt-auto'>
