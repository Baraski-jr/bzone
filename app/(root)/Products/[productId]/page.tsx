  ...
  return (
    <section className="">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-[95%] mx-auto">
        ...
        <div className="md:flex">
          <div className="hidden md:flex flex-col gap-y-1 pr-1 pt-5">
            <button className="overflow-hidden rounded-lg border-2 border-transparent hover:border-slate-300 h-fit transition-all duration-300">
              <Image width={50} height={50} className='bg-[#F5F5F5] rounded-xl' src="/products/a1.png" alt="shoes" />
            </button>
            <button className="overflow-hidden rounded-lg border-2 border-transparent hover:border-slate-300 h-fit transition-all duration-300">
              <Image width={50} height={50} className='bg-[#F5F5F5] rounded-xl' src="/products/a2.png" alt="shoes" />
            </button>
            <button className="overflow-hidden rounded-lg border-2 border-transparent hover:border-slate-300 h-fit transition-all duration-300">
              <Image width={50} height={50} className='bg-[#F5F5F5] rounded-xl' src="/products/a1.png" alt="shoes" />
            </button>
        ...
        <div className="border-2 w-full min-h-[50vh]">
